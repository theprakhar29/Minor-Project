...
import TranserFundsModal from "./TransferFundsModel";
import { useDispatch, useSelector } from "react-redux";
import { HideLoading, ShowLoading } from "../../redux/loaderSlice";
import { GetTransationsOfUser } from "../../apicalls/transactions";
...
function Transactions() {
  ...
  const getData = async () => {
    try {
      ...
      const response = await  GetTransationsOfUser();
      if (response.success) {
